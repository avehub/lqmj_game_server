...
from promising_game.interface.ads_stats import JuLiangAdsMonitor, CommonAdsMatchedData, DataNexusAdsMonitor
from promising_game.interface.friend import GetUserFriendList, FriendshipOperate
from promising_game.interface.game_chat import GetQuickChatConf, GetChatRecords, SendChatMessage
from promising_game.interface.game_ranking import GetUserRankingInfo, GetRankingList, RankingPullAwards, \
    ModifyUserRankingInfo, GetSeasonRankingConf, GetPlayerRankingInfo
from promising_game.interface.interaction import AnnouncementsHandler
from promising_game.interface.player_skin import SkinDharmaForm, SkinDharmaAppear, UseSkinItem, UpgradeSkinItem, \
    GetGameSkinUsedItems, GetSkinAllStarItems, UseLimitedTimeSkin
from promising_game.interface.test_api import TestApi
from promising_game.interface.get_u_info import QueryUserInfo, RefreshAssets, QueryUserGameStates, \
...
from promising_game.interface.player_vault import BagHandler, DropBagItem, SafeBoxHandler, \
...
from promising_game.interface.login import LoginByGuest, LoginByToken, LoginByWechatMiniProgram, LoginByWechat, \
    LoginByAlipayGame, LoginByDouYinGame
from promising_game.interface.up_u_info import ModifyGeneralUserInfo, Certification, TestAddGold, GetSessionKey, \
    GetWeChatGzhOpenid
from promising_game.interface.some_pay import AliPayNotify, MiniGameRecvPush, MakeOrder, MiniGameQueryOrder, \
    ...
    CompletePaidOrder
from promising_game.interface.store import StoreHandler, PayByRedemption, SwitchStaHandler
from promising_game.interface.interaction import MakeAdOrder, CompleteAdOrder, SignInHandler, SignInComplete, \
    SignInTotalComplete, GetReliefHandler, GetReliefConf, GetCommonAwardsConf, PullCommonAwards, OpenTreasureBox
from promising_game.interface.mails import MailsListHandler, MailsOperateUser, MailsOperateOneClick
from promising_game.interface.game_tasks import GameTaskComplete, GameActiveComplete, GameTaskHandler, GameTaskUpdate, \
    GameTaskUpdateForRookie
from promising_game.interface.activitys import GetActivityAwards, VipLevelHandler, VipLevelPullAwards, \
    GetActivityHandler
from promising_game.interface.west_way import WestWayQueryMap, WestWayQueryGoods, WestWayPlaySteps
...
class MainBp(BaseBlue):
    ...
    DEFAULT_APIS = [
        ...
        Urls("/LoginByWechatMiniProgram/", LoginByWechatMiniProgram),  # 微信MG登陆
        Urls("/LoginByWechat/", LoginByWechat),  # 微信登录 （新）
        Urls("/LoginByAlipayGame/", LoginByAlipayGame),  # 支付宝MG登录
        Urls("/LoginByDouYinGame/", LoginByDouYinGame),  # 抖音MG登录
