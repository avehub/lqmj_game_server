...
ADD COLUMN `status`  tinyint NOT NULL DEFAULT '0' COMMENT '用户状态：0正常 1注销' AFTER `updated`;
...
INSERT INTO `lucky_game`.`conf_json` (`created`, `conf_id`, `conf_data`, `desc`, `update_time`) VALUES (0, 'CONF_TOURNAMENT_WHITE', '{\"status\": 0, \"special_uid\": [151218]}', '赛事配置白名单', 0);
